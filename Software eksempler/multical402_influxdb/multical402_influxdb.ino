...
#define HOSTNAME "MULTICAL402"     // Friedly hostname



// InfluxDB v2 server url, e.g. https://eu-central-1-1.aws.cloud2.influxdata.com (Use: InfluxDB UI -> Load Data -> Client Libraries)
#define INFLUXDB_URL "http://192.168.10.2:8086"
...
#define READmulticalEVERY  600000  //1000                                                      //read multical every 2000ms
#define NBREG   7   
...
multical_struct multicalarr[NBREG] = {
  {0.00, 0x003C,"Energy"},                                                      //kWh
  {0.00, 0x0050,"Current Power"},                                                      //kW
  {0.00, 0x0056,"Temperature t1"},                                                      //Degrees
  {0.00, 0x0057,"Temperature t2"},                                                      //Degrees
  {0.00, 0x0059,"Temperature diff"},                                                      //Degrees
  {0.00, 0x004a,"Flow"},                                                      //L/h
  {0.00, 0x0044,"Volumen 1"},                                                   //m^3 
};
